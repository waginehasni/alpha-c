...
int main ()
{
 			        SDL_Surface*ecran=NULL,*menu=NULL,*texteplay=NULL,*texteoption=NULL,*textemulti=NULL,*textequit=NULL,*star=NULL,*commentaireplay=NULL,*commentaireoption=NULL,*commentairemulti=NULL,*commentairequit=NULL,*shab1=NULL,*shab2=NULL,*shab3=NULL,*logo=NULL,*embleme=NULL;
    SDL_Rect posvolb,posshab1,posshab2,posshab3,positionFond, posquit, posmulti, posoption, posplay,posstar, poscquit, poscmulti, poscoption, poscplay,poslogo;
    ...
    int continuer=1,transp=0,compteurTrans=1,son=0,direction=1,direction2=1,direction3=1,mute=0,temps=0;
    SDL_Event event;

chargerTous(&ecran,&star,&shab1,&shab2,&shab3,&menu,&texteplay,&textemulti,&texteoption,&textequit,&musique,&effet,&sonspell,&dying,&hit,&effet2,&police,&police1,couleur);
intro(&ecran);
remplirlesposition(&positionFond,&posquit,&posmulti,&posoption,&posplay,&posstar,&poscquit,&poscmulti,&poscoption,&poscplay,&posshab1,&posshab2,&posshab3,&posvolb);
